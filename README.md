...
Проверить доступность Swagger JSON (если раздаёте статикой)
curl http://localhost:8080/swagger/doc.json | head

Health check (если ручка добавлена)
...
- 🔄 Друзья и рекомендации — социальные функции
